...
const enterUUID = {
  title: "個人識別番号入力",
  description:
    "実験実施者から受け取った紙に書かれている個人識別番号を入力してください。",
  label: "個人識別番号",
                ...
                <form className="space-y-6" action="#">
                  <div>
                    ...
                    <input
                      ...
                      name="id"
                      id="id-text"
                      className="block w-full rounded-lg border border-blue-300 bg-gray-50 p-2.5 text-base text-gray-900 focus:border-blue-500 focus:ring-blue-500 disabled:bg-gray-300"
                    ...
                    <div className="flex items-start">
                      <div className="flex h-5 items-center">
                        <input
                          ...
                          name="noUUID"
                          type="checkbox"
                          className="h-4 w-4 rounded border-gray-300 bg-gray-50 text-blue-500 focus:ring-blue-500"
                        />
                      </div>
                      <label
                        htmlFor="noUUID"
